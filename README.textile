...
devise_oauth2_facebook    "https://github.com/mooktakim/devise_oauth2_facebook":https://github.com/intridea/oauth2
authlogic_oauth2          "https://github.com/andyhite/authlogic_oauth2":https://github.com/intridea/oauth2
...
# register a user with admin/123456
...
# click the "get articles!" link
# when ask for login, login with you username/password on the Blog app
# make sure check the checkbox and click submit when ask for permission.
# then you should see the data returned from the provider app
