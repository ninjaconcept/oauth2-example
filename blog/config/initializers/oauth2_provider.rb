...
module Oauth2
  module Provider
    ...
    # # make sure login first for OauthAuthorizeController
    # OauthAuthorizeController.before_filter(:login_required)
    
    # TODO: use host app's custom authorization filter to protect OauthClientsController
